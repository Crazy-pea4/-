        ...
        yx_rotaion: function (options) {
            ...
            return this.each(function () {
				...
				*/
                ...
                if (!o.btn) $("." + o.css_yx_rotaion_btn).css({
                    visibility: 'hidden'
                });
                ...
                var $btn = $this.find("." + o.css_yx_rotaion_btn + " span"),
                    $title = $this.find("." + o.css_yx_rotation_t),
                    $title_bg = $this.find("." + o.css_yx_rotation_title),
                    $focus = $this.find("." + o.css_yx_rotation_focus);
                //如果自动播放，设置定时器
