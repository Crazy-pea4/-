  ...
  <div class="cart-complete-wrap">
    <div class="cart-complete">
      ...
      <div class="goods">
        <div class="left-good">
          <div class="left-pic">
            <img :src="shopCartInfo.skuInfo.skuDefaultImg" />
          </div>
        ...
        <div class="right-gocart">
          <!-- <router-link
            ...
            :to="{
              name: 'detail',
              params: {
                goodsId: this.shopCartInfo.skuInfo.id,
              },
            }"
            >查看商品详情</router-link
          > -->
          <a class="sui-btn btn-xlarge" @click="backToDetail">查看商品详情</a>
...
export default {
  ...
  computed: {
    shopCartInfo() {
      return JSON.parse(sessionStorage.getItem("shopCartInfo"));
    },
  },
  methods: {
    backToDetail() {
