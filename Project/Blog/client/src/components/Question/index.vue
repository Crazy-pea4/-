    ...
    <div class="w-full h-auto float-left" @click="ToQuestion">
        <a-skeleton active :loading="loading">
            ...
            <template v-if="questionStore[props.storeType].length > 0">
                <div class="w-full h-36 border-2 border-gray-300 relative rounded-sm
                        hover:shadow flex flex-col justify-around text-center 
                        cursor-pointer my-5 px-5 first:mt-0 last:mb-0"
