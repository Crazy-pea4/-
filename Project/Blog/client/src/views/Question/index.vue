<template>
  <div class="min-h-screen">
    <!-- 顶部问题标题区 -->
    <header
      class="w-full pt-10 bg-black bg-opacity-40 shadow"
      v-if="questionStore.question"
    >
      <a-skeleton active :loading="loading">
        <div class="w-sHeart mx-auto flex flex-col lg:w-sHeart 2xl:w-mHeart">
          ...
          <!-- 简介（描述） -->
          <div
            class="w-full text-sm max-h-16 my-4 overflow-hidden overflow-ellipsis"
          >
          ...
          <div class="w-full flex justify-between items-center h-14">
            <div class="flex rounded-md">
              <div
                class="w-20 h-8 border-gray-200 border-1 rounded-md flex justify-center items-center cursor-pointer"
                @click="collectingQuestion"
                :class="{
              ...
              <div
                class="w-20 h-8 ml-4 border-1 flex justify-center items-center rounded-md border-gray-200 cursor-pointer"
                @click="ToWrite"
              >
                写回答
              </div>
            ...
            <div class="flex justify-center truncate">
              <div
                v-for="i in questionStore.question.topics"
                :key="i._id"
